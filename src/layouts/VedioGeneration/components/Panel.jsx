                ...
                return (
                    <VStack align="stretch" spacing={4}>
                        ...
                        <Box>
                            <Text fontWeight="bold">Target Width (px)</Text>
                            <Input
                                type="number" placeholder="Enter width in px" value={resizeImageSettings.targetWidth}
                                onChange={(e) =>
                                    startTransition(() => { // ✅ Wrapped in startTransition
                        ...
                        <Box>
                            <Text fontWeight="bold">Target Height (px)</Text>
                            <Input
                                type="number" placeholder="Enter height in px" value={resizeImageSettings.targetHeight}
                                onChange={(e) =>
                                    startTransition(() => { // ✅ Wrapped in startTransition
                                        setResizeImageSettings((prev) => ({
                                            ...prev, targetHeight: e.target.value,
                        ...
                        <Box>
                            <Text fontWeight="bold">Resize Method</Text>
                            <Select
                                placeholder="Select resize method" value={resizeImageSettings.resizeMethod}
                                onChange={(e) =>
                                    startTransition(() => { // ✅ Wrapped in startTransition
                                        setResizeImageSettings((prev) => ({
                                            ...prev, resizeMethod: e.target.value,
                        ...
                        <Box>
                            <Text fontWeight="bold">Quality (1–100)</Text>
                            <Input
                                type="number" min="1" max="100" placeholder="85" value={resizeImageSettings.quality}
                                onChange={(e) =>
                                    startTransition(() => { // ✅ Wrapped in startTransition
                                        setResizeImageSettings((prev) => ({
                                            ...prev, quality: e.target.value,
                ...
                return (
                    <VStack align="stretch" spacing={4}>
                        ...
                        <Box>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    startTransition(() => { // ✅ Wrapped in startTransition
                                        setImageToVideoSettings((prev) => ({
                                            ...prev, layover_text: e.target.value,
                                        }))
                                    })
                                }
                                mt={2}
                        ...
                        <Box>
                            ...
                            <Input
                                placeholder="Enter project name" value={imageToVideoSettings.project_name}
                                onChange={(e) =>
                                    startTransition(() => { // ✅ Wrapped in startTransition
                                        setImageToVideoSettings((prev) => ({
                        ...
                        <Box>
                            ...
                            <Input
                                placeholder="e.g. sale, discount, ad" value={imageToVideoSettings.tags}
                                onChange={(e) =>
                                    startTransition(() => { // ✅ Wrapped in startTransition
                                        setImageToVideoSettings((prev) => ({
                        ...
                        <Box>
                            ...
                            <Select
                                placeholder="Select sector" value={imageToVideoSettings.sector}
                                onChange={(e) =>
                                    startTransition(() => { // ✅ Wrapped in startTransition
                                        setImageToVideoSettings((prev) => ({
                                            ...prev, sector: e.target.value,
                                        }))
                                    })
                                }
                                mt={2}
                        ...
                        <Box>
                            ...
                            <Textarea
                                placeholder="Describe the project goal" value={imageToVideoSettings.goal}
                                onChange={(e) =>
                                    startTransition(() => { // ✅ Wrapped in startTransition
                                        setImageToVideoSettings((prev) => ({
                        ...
                        <Box>
                            ...
                            <Textarea
                                placeholder="Enter message for the audience" value={imageToVideoSettings.consumer_message}
                                onChange={(e) =>
                                    startTransition(() => { // ✅ Wrapped in startTransition
                                        setImageToVideoSettings((prev) => ({
                                            ...prev, consumer_message: e.target.value,
                                        }))
                                    })
                                }
                                mt={2}
                        ...
                        <Box>
                            ...
                            <Select
                                placeholder="Select M_Key" value={imageToVideoSettings.M_key}
                                onChange={(e) =>
                                    startTransition(() => { // ✅ Wrapped in startTransition
                                        setImageToVideoSettings((prev) => ({
                                            ...prev, M_key: e.target.value,
                                        }))
                                    })
                                }
                                mt={2}
                        ...
                        <Box>
                            ...
                            <Select
                                placeholder="Select video type" value={imageToVideoSettings.video_type}
                                onChange={(e) =>
                                    startTransition(() => { // ✅ Wrapped in startTransition
                                        setImageToVideoSettings((prev) => ({
                                            ...prev, video_type: e.target.value,
                                        }))
                                    })
                                }
                                mt={2}
                        ...
                        <Box>
                            ...
                            <SimpleGrid columns={{ base: 2, sm: 3 }} spacing={4} mt={2}>
                                {Object.entries(video_dimensions_choices).map(([label, val]) => {
                                    const icon = label.includes("16:9") ? MdCrop169 : label.includes("9:16") ? MdCropPortrait : MdCropSquare;
                                    const isSelected = imageToVideoSettings.aspect_ratio === val;
                                    return (
                                        <Flex
                                            key={val} direction="column" align="center" justify="center" borderWidth="2px"
                                            borderColor={isSelected ? "blue.500" : panelBg}
                                            bg={isSelected ? panelBg : "transparent"}
                                            color={isSelected ? "blue.600" : "inherit"}
                                            borderRadius="xl" p={3} cursor="pointer" transition="all 0.2s"
                                            _hover={{ borderColor: "blue.400", bg: panelBg, transform: "scale(1.05)" }}
                                            onClick={() =>
                                                startTransition(() => { // ✅ Wrapped in startTransition
                                                    setImageToVideoSettings((prev) => ({
                                                        ...prev, aspect_ratio: val,
                                                    }))
                                                })
                                            }
                                        >
                        ...
                        <Box>
                            ...
                            <Select
                                placeholder="Select option" value={imageToVideoSettings.customSize}
                                onChange={(e) => {
                                    const value = e.target.value;
                                    startTransition(() => { // ✅ Wrapped in startTransition
                                        setImageToVideoSettings((prev) => ({
                            ...
                            {imageToVideoSettings.customSize === "true" && (
                                <>
                                    <Box mt={4}>
                                        ...
                                        <Input
                                            type="number" placeholder="Width in px" value={imageToVideoSettings.customWidth}
                                            onChange={(e) =>
                                                startTransition(() => { // ✅ Wrapped in startTransition
                                                    setImageToVideoSettings((prev) => ({
                                                        ...prev, customWidth: e.target.value,
                                                    }))
                                                })
                                            }
                                            mt={2}
                                    ...
                                    <Box mt={4}>
                                        ...
                                        <Input
                                            type="number" placeholder="Height in px" value={imageToVideoSettings.customHeight}
                                            onChange={(e) =>
                                                startTransition(() => { // ✅ Wrapped in startTransition
                                                    setImageToVideoSettings((prev) => ({
                                                        ...prev, customHeight: e.target.value,
                                                    }))
                                                })
                                            }
                                            mt={2}
