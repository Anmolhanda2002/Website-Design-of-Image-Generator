...
export default function EditVideoGuideline() {
    ...
    const fetchData = async () => {
      try {
        ...
        const [choicesRes, guidelineRes] = await Promise.all([
          ...
          axiosInstance.post("/factory_development_get_video_guideline_detail/", {guideline_id,user_id:activeUserId }),
        ]);
  ...
  const handleUpdate = async () => {
    try {
      ...
      const payload = {  guideline_id,user_id:activeUserId, ...form };
